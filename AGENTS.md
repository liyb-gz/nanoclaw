...
Single Node.js process that connects to WhatsApp, routes messages to OpenCode SDK running in Apple Container (Linux VMs). Each group has isolated filesystem and memory.
